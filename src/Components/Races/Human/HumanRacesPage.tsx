        ...
        <div className={classes.pageHumanRaces}>
            ...
            <div className={classes.overlayBlockContentRace}>
                <div className={classes.blockContentRace}>
                    <h1 className={classes.headingBlockContentRace1}>Люди</h1>
                ...
                <button className={classes.transitionButtonRace} onClick={handleFactionsPageTransition}>Главная</button>
        </div>
    )
};